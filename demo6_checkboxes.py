...
class MyGUI:
    def __init__(self):
        ...
        #Create 3 IntVar objects to use with the Checkboxes
        ...
        # yes you have to pack the frames too!
...
my_gui = MyGUI()
#will not run until the main loop is fuinihsed by  closing out of the window
print('moving on.....')